...
class CadastrarAnotacao extends StatefulWidget {
  const CadastrarAnotacao({super.key});

  @override
  State<CadastrarAnotacao> createState() => _CadastrarAnotacaoState();
}

class _CadastrarAnotacaoState extends State<CadastrarAnotacao> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          if (_formKey.currentState!.validate()) {
            context.read<AnotacaoRepository>().save(
              Anotacao(
                Uuid().v1(),
